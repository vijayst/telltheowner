...
import { TellTheOwnerEmbed } from "@/components/TellTheOwnerEmbed";
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/how-it-works"
              className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 transition border-2 border-blue-600"
            >
              See How It Works
            </a>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-600 leading-relaxed">
              Customers speak their reviews naturally. Our AI transcribes voice
              into clear, searchable text automatically.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-600 leading-relaxed">
              Reviews are private — only you can see them. Perfect for genuine
              feedback without public pressure.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-20 bg-gradient-to-b from-indigo-50 via-purple-50 to-white">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6 border-l-4 border-purple-600">
                <p className="text-lg leading-relaxed text-gray-800 italic">
                  ...
                  amazing! The pasta was perfectly cooked and the sauce had such
                  rich flavor. The service was also fantastic — our server was
                  really attentive and made great recommendations. Only thing
                  I'd suggest is maybe adding a few more vegetarian options to
                  the menu. Overall, definitely coming back!"
                </p>
              </div>
            </div>
          ...
          <div className="text-center mt-8">
            <a
              href="/product/review-demo"
              className="text-purple-600 hover:text-purple-700 font-semibold text-lg inline-flex items-center gap-2 transition"
            >
      ...
      <section
        id="how-it-works"
        className="container mx-auto px-6 py-20 bg-gradient-to-b from-green-50 to-emerald-50"
      >
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-4">
          How It Works
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Sign up and provide basic information about your business to get
              started.
            </p>
          </div>
          <div className="text-center">
      ...
      <section
        id="benefits"
        className="container mx-auto px-6 py-20 bg-gradient-to-b from-amber-50 via-orange-50 to-white"
      >
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="flex items-start gap-4 bg-white rounded-xl p-6 shadow-md border border-orange-200">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Without public pressure, customers share more genuine, detailed
                reviews.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4 bg-white rounded-xl p-6 shadow-md border border-orange-200">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Speaking is easier than typing. Capture more reviews from busy
                customers.
              </p>
            </div>
          </div>
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-12 text-center shadow-2xl">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses gathering private, honest feedback from
            their customers.
          </p>
          <a
            href="/login"
