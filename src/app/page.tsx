      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold text-blue-400 mb-4">telltheowner</h3>
              <p className="text-gray-400">
                Private customer reviews for businesses that value honest feedback.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition">QR Codes</a></li>
              </ul>
            </div>
            <div>
